              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isLast = index == provider.foodOrders.length - 1;
                    ...
                    final previousDate = index > 0
                        ? DateFormat('yyyy-MM-dd')
                            .format(provider.foodOrders[index - 1].time)
                        : null;

                    // Check if the day has changed
                    final isNewDay = index == 0 || currentDate != previousDate;

                    String timeInHours = DateFormat('HH:mm')
                        .format(DateTime.parse(item.time.toIso8601String()));
