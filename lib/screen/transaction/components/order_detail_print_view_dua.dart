...
class OrderDetailPrintViewDua extends StatefulWidget {
  final TransactionData transaction;
  final ReceiptController? controller;
  const OrderDetailPrintViewDua(
      {super.key, required this.transaction, this.controller});

  @override
  State<OrderDetailPrintViewDua> createState() =>
      _OrderDetailPrintViewDuaState();
  static void print(
...
class _OrderDetailPrintViewDuaState extends State<OrderDetailPrintViewDua> {
